...
export function SignOutIcon({ className, strokeWidth }: IconProps) {
  return (
    <svg className={className} {...base(strokeWidth)}>
...
export function KeyIcon({ className, strokeWidth }: IconProps) {
  return (
    <svg className={className} {...base(strokeWidth)}>
...
export function PaperClipIcon({ className, strokeWidth }: IconProps) {
  return (
    <svg className={className} {...base(strokeWidth)}>
